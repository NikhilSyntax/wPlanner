...
module.exports = {
  ...
  // Restrict endpoint to admin or sub-admin users
  ...
  // Restrict endpoint to primary full admins only (e.g. role delegation, roster removal)
  fullAdminOnly: (req, res, next) => {
  ...
  roleRestriction: (requiredRoles) => {
    return (req, res, next) => {
      ...
      // Admins and Sub-Admins have clearance across team/event/announcement management
